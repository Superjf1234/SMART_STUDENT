...
class AppState(rx.State):
    ...
    async def download_summary_pdf(self):
        ...
        if pdf_bytes:
            rx.download(pdf_bytes, f"Resumen_{self.selected_tema}.pdf")
        else:
            self.error_message_ui = "Error al generar el PDF."
    ...
    def start_repaso(self, history_entry: dict):
        self.selected_curso = history_entry['curso']
        self.selected_libro = history_entry['libro']
        self.selected_tema = history_entry['tema']
