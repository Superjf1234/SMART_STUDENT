...
def cuestionario_tab_content() -> rx.Component:
    ...
    return rx.vstack(
        # Encabezado principal (más didáctico y centrado)
        rx.heading(
            "🧐 ¡Desafía tu Conocimiento con Cuestionarios!", # Título más didáctico
            size="6",
            mb="2em", # Margen igual a mapa_tab
            text_align="center",
        ),
        ...
        rx.card(
            rx.vstack(
                ...
                rx.input( # Tema (usando input como en el refactor anterior, podría ser text_area como mapa_tab si se prefiere)
                    ...
                    is_disabled=rx.cond(CuestionarioState.selected_libro == "", True, False), # Añadido is_disabled
                ),
