            ...
            rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.cond(
                        ...
                        # --- Usamos rx.vstack y rx.foreach para renderizar los botones de radio ---
                        rx.vstack(
                            rx.foreach(
                                ...
                                lambda opcion: rx.hstack(
                                    rx.radio(
                                        ...
                                        value=opcion["letra"],
                                        checked=(
                                            EvaluationState.eval_user_answers.get(
                        ...
                        # Mensaje para tipos de pregunta no implementados
                        rx.text(
