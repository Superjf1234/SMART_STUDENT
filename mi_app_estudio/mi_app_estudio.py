...
def evaluacion_tab():
    ...
    return rx.vstack(
        ...
        rx.center(
            rx.hstack(
                rx.heading("📝 Evaluación de Conocimientos", size="6"),
                    ...
                    rx.vstack(
                        ...
                        rx.button(
                            rx.cond(
                                ...
                                rx.hstack(rx.spinner(size="2"), rx.text("Generando evaluación...")),
                                rx.hstack(rx.icon("clipboard-check"), rx.text("Crear Evaluación"))
                            ),
...
def inicio_tab():
    ...
    return rx.vstack(
        ...
        rx.center(
            rx.hstack(
                rx.heading("🏠 Bienvenido a SMART STUDENT", size="6"),
...
def resumen_tab():
    ...
    return rx.vstack(
        ...
        rx.center(
            rx.hstack(
                rx.heading("📄 Genera Resúmenes Inteligentes", size="6"),
...
def mapa_tab():
    ...
    return rx.vstack(
        ...
        rx.center(
            rx.hstack(
                rx.heading("🧠 Crea Mapas Conceptuales", size="6"),
...
def perfil_tab():
    ...
    return rx.vstack(
        ...
        rx.center(
            rx.hstack(
                rx.heading("👤 Perfil Personal", size="6"),
        ...
        rx.card(
            rx.vstack(
                rx.hstack(
                    ...
                    rx.vstack(
                        rx.heading("felipe", size="4", mb="0.5em"),
                        rx.text("Estudiante Activo", color="gray.500"),
                        
                        # Lista de información del usuario en formato horizontal
                        rx.vstack(
                            # Último acceso
                            rx.hstack(
                                rx.text("Último acceso:", font_weight="bold", width="150px"),
                                rx.text("Hoy"),
                                width="100%",
                                justify="start",
                            ),
                            ...
                            # Nivel
                            rx.hstack(
                                rx.text("Nivel:", font_weight="bold", width="150px"),
                                rx.text("Estudiante Avanzado"),
                                width="100%",
                                justify="start",
                            ),
                            ...
                            # Curso Activo
                            rx.hstack(
                                rx.text("Curso Activo:", font_weight="bold", width="150px"),
                                rx.text("4to Básico"),
                                width="100%",
                                justify="start",
                            ),
                            ...
                            # Asignaturas
                            rx.hstack(
                                rx.text("Asignaturas:", font_weight="bold", width="150px"),
                                rx.hstack(
                            ...
                            rx.hstack(
                                rx.text("Evaluaciones Completadas:", font_weight="bold", width="150px"),
                                rx.text("12"),
                                width="100%",
                                justify="start",
                            ),
        ...
        rx.card(
            rx.vstack(
                rx.hstack(
                    ...
                    rx.heading("📊 Estadísticas de Aprendizaje", size="5"),
                    spacing="2",
                ),
                
                # MODIFICADO: Progreso por materia - Barras de progreso alineadas
                rx.vstack(
                    rx.heading("Progreso por Materia", size="4", mb="1em"),
                    ...
                    rx.vstack(
                        ...
                        rx.hstack(
                            rx.box(
                                rx.text("Matemáticas", align_self="center"),
                                width="150px", 
                                min_width="150px",
                            ),
                            rx.box(
                            ...
                            rx.text("85%", min_width="50px", text_align="right"),
                            width="100%",
                            align_items="center",
                            spacing="3",
                        ),
                        ...
                        rx.hstack(
                            rx.box(
                                rx.text("Ciencias", align_self="center"),
                                width="150px", 
                                min_width="150px",
                            ),
                            rx.box(
                            ...
                            rx.text("70%", min_width="50px", text_align="right"),
                            width="100%",
                            align_items="center",
                            spacing="3",
                        ),
                        ...
                        rx.hstack(
                            rx.box(
                                rx.text("Historia", align_self="center"),
                                width="150px", 
                                min_width="150px",
                            ),
                            rx.box(
                            ...
                            rx.text("60%", min_width="50px", text_align="right"),
                            width="100%",
                            align_items="center",
                            spacing="3",
                        ),
                        ...
                        rx.hstack(
                            rx.box(
                                rx.text("Lenguaje", align_self="center"),
                                width="150px", 
                                min_width="150px",
                            ),
                            rx.box(
                            ...
                            rx.text("90%", min_width="50px", text_align="right"),
                            width="100%",
                            align_items="center",
                            spacing="3",
                        ),
                ...
                rx.hstack(
                    # Evaluaciones completadas - Azul
                    rx.box(
                        rx.vstack(
                            rx.heading("12", size="3", color="white", font_size="2em", mb="0"),
                    ...
                    rx.box(
                        rx.vstack(
                            rx.heading("85%", size="3", color="white", font_size="2em", mb="0"),
                            rx.text("Promedio de", font_size="sm", color="white", text_align="center"),
                    ...
                    rx.box(
                        rx.vstack(
                            rx.heading("24", size="3", color="white", font_size="2em", mb="0"),
                    ...
                    rx.box(
                        rx.vstack(
                            rx.heading("18", size="3", color="white", font_size="2em", mb="0"),
...
def ayuda_tab():
    ...
    return rx.vstack(
        ...
        rx.center(
            rx.hstack(
                rx.heading("🔍 Centro de Ayuda", size="6"),
        ...
        rx.text(
            "Aquí encontrarás respuestas a preguntas frecuentes que te harán como Student.",
            color="gray.500",
            mb="2em",
            text_align="center",
            max_width="600px",
        ...
        rx.card(
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.heading("Preguntas Frecuentes", size="5", mb="1em"),
                    spacing="2",
                    width="100%",
                    justify="center",
                    align_items="center",
                ...
                rx.foreach(
                    ...
                    lambda pregunta, i: rx.vstack(
                        ...
                        rx.box(
                            rx.hstack(
                                rx.icon("question-mark", size=16, color="#333"),
                            ...
                            width="100%",
                            on_click=lambda i=i: AppState.toggle_pregunta(i),
                        ),
                ...
                rx.vstack(
                    rx.heading("¿No encontraste lo que buscabas?", size="5", mb="1em", text_align="center"),
                    rx.button(
                        rx.hstack(
...
def libros_tab():
    ...
    return rx.vstack(
        ...
        rx.center(
            rx.hstack(
                rx.heading("📚 Biblioteca Digital", size="6"),
