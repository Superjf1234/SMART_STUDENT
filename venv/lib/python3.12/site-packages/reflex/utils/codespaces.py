...
redirect_script = """
// Evitar declaración duplicada de 'thisUrl'
if (typeof window.rxThisUrlFlag === 'undefined') {
    window.rxThisUrlFlag = true;
    var thisUrl = new URL(window.location.href);
    var params = new URLSearchParams(thisUrl.search)
} else {
    // Ya se ha ejecutado este script previamente
}
