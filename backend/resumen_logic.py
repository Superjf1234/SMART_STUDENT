...
def formatear_resumen(resumen_texto, tema_solicitado):
    ...
    unwanted_titles = [
        ...
        f"Resumen Extendido y Detallado del Texto '{tema_solicitado}'",
        f"Resumen del texto '{tema_solicitado}'",
        f"Resumen detallado del texto '{tema_solicitado}'",
        f"Resumen sobre '{tema_solicitado}'",
        f"Resumen: {tema_solicitado}",
        f"Resumen de {tema_solicitado}",
        f"Resumen del tema '{tema_solicitado}'",
        f"Resumen del tema: {tema_solicitado}",
