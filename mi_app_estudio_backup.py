                                ...
                                rx.box(
                                    ...
                                    bg=rx.cond(
                                        ...
                                        rx.cond(
                                            ...
                                            rx.cond(
                                                ((EvaluationState.eval_score >= 6)0) & ((EvaluationState.eval_score < 8)0), "var(--amber-2)",
                                                rx.cond(
                                                    ((EvaluationState.eval_score >= 8)0) & ((EvaluationState.eval_score < 9)0), "var(--green-2)",
                                                    "var(--teal-2)"
                                                )
                                            )
                                        )
                                    ...
                                    border_color=rx.cond(
                                        ((EvaluationState.eval_score < 4)0), "var(--red-6)",
                                        rx.cond(
                                            ((EvaluationState.eval_score >= 4)0) & ((EvaluationState.eval_score < 6)0), "var(--orange-6)",
                                            rx.cond(
                                                ((EvaluationState.eval_score >= 6)0) & ((EvaluationState.eval_score < 8)0), "var(--amber-6)",
                                                rx.cond(
                                                    ((EvaluationState.eval_score >= 8)0) & ((EvaluationState.eval_score < 9)0), "var(--green-6)",
                                                    "var(--teal-6)"
                                                )
                                            )
                                        )
